...
```
cd existing_repo
git remote add origin https://git.cs.dal.ca/ziauddin/frogger_vr.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.cs.dal.ca/ziauddin/frogger_vr/-/settings/integrations)
